...
/**
 * @author Created by WZW on 2021-04-25 10:44.
 * @description
 */
...
public class MyAudioManager {
    ...
    static int requestAudioFocus(AudioListener listener) {
        ...
        if (mAudioManager == null) {
            mAudioManager = (AudioManager) AppInit.getInstance().getSystemService(Context.AUDIO_SERVICE);
        }
                ...
                public void onAudioFocusChange(int focusChange) {
                    switch (focusChange) {
                        case AudioManager.AUDIOFOCUS_GAIN:
                            ...
                            KLog.e("audioManager", "audio_focus_gain");
                            if (mListener != null) {
                        ...
                        case AudioManager.AUDIOFOCUS_LOSS:
                            // 长时间丢失
                            // 网易云音乐播放 微信聊天
                            KLog.e("audioManager", "audio_focus_loss");
                            if (mListener != null) {
                                mListener.audioPause();
                            }
                            break;
                        case AudioManager.AUDIOFOCUS_LOSS_TRANSIENT:
                            // 暂时丢失
                            // 电话接听 录音播放
                            KLog.e("audioManager", "audio_focus_loss_transient");
                            if (mListener != null) {
                                mListener.audioPause();
                            }
                            break;
                        case AudioManager.AUDIOFOCUS_LOSS_TRANSIENT_CAN_DUCK:
                            ...
                            // 放大 or 放小音量处理
                            KLog.e("audioManager", "audio_focus_loss_transient_can_duck");
                            break;
                    }
                }
            };
